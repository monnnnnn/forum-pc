...
window.onload = function(){
    ...
    $.ajax({
        type: 'post',
        url: 'http://120.79.232.81:9000/InvitationVO/selectMyAttentionInvitationByUserId',
        dataType: 'json',
        data:{
            userId: userId
        },
...
function onSearch() {
    ...
    if(searchTitle !=''){
        ...
        $.ajax({
            type: 'post',
            url: "http://120.79.232.81:9000/InvitationVO/selectMyAttentionInvitationByUserIdAndTitle",
            dataType: 'json',
            data: {
                userId: userId,
                title: searchTitle,
